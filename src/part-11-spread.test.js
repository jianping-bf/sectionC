...
test("re-write the swapByIndex function from the 'arrays' section to use the spread operator", () => {
...
test("use the rest and spread operators to repalce a property with other", () => {
  ...
  // todo ...
  let { heightKm, ...rest } = rocket;
  let result = { ...rest, heightMeters: heightKm * 1000 };
